...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Element: {
      "^": "Node;id=,_namespaceUri:namespaceURI=,tagName=",
    ...
    JsonParser: {
      ...
      parse$0: function() {
        var states, t1, $length, t2, t3, t4, state, position, char, position0, t5;
        ...
        while (true) {
          ...
          if (!(position < $length))
            break;
          char = t2._codeUnitAt$1(t1, position);
          switch (char) {
            case 32:
            case 13:
            case 10:
            ...
            case 91:
              if ((state & 4) !== 0)
                this.fail$1(position);
              if (!!J.getInterceptor(t3.currentContainer).$isMap)
                t4.push(t3.key);
              t4.push(t3.currentContainer);
              t3.currentContainer = [];
              states.push(state);
              ++position;
              state = 1;
            ...
            case 123:
              ...
              if (!!J.getInterceptor(t3.currentContainer).$isMap)
                t4.push(t3.key);
              t4.push(t3.currentContainer);
              t3.currentContainer = P.LinkedHashMap__makeEmpty();
              states.push(state);
              ++position;
              state = 6;
              break;
            case 110:
              ...
              if (C.JSString_methods._codeUnitAt$1(t1, position + 1) !== 117 || C.JSString_methods._codeUnitAt$1(t1, position + 2) !== 108 || C.JSString_methods._codeUnitAt$1(t1, position + 3) !== 108)
                this.fail$1(position);
              t3.value = null;
              state |= 28;
              position = position0;
            ...
            case 102:
              ...
              if ($length < position0)
                this.fail$2(position, "Unexpected identifier");
              if (C.JSString_methods._codeUnitAt$1(t1, position + 1) !== 97 || C.JSString_methods._codeUnitAt$1(t1, position + 2) !== 108 || C.JSString_methods._codeUnitAt$1(t1, position + 3) !== 115 || C.JSString_methods._codeUnitAt$1(t1, position + 4) !== 101)
                this.fail$1(position);
              t3.value = false;
              state |= 28;
              position = position0;
            ...
            case 116:
              ...
              if ($length < position0)
                this.fail$2(position, "Unexpected identifier");
              if (C.JSString_methods._codeUnitAt$1(t1, position + 1) !== 114 || C.JSString_methods._codeUnitAt$1(t1, position + 2) !== 117 || C.JSString_methods._codeUnitAt$1(t1, position + 3) !== 101)
                this.fail$1(position);
              t3.value = true;
              state |= 28;
              position = position0;
            ...
            case 93:
              if (state === 1) {
                t3.value = t3.currentContainer;
                if (0 >= t4.length)
                  return H.ioore(t4, -1);
                t5 = t4.pop();
                t3.currentContainer = t5;
                if (!!J.getInterceptor(t5).$isMap) {
                  if (0 >= t4.length)
                    return H.ioore(t4, -1);
                  t3.key = t4.pop();
                }
      ...
      parseString$1: function(position) {
        var t1, t2, t3, t4, position0, char, firstEscape, chars, hexStart, value, i, result;
        t1 = this.source;
        t2 = J.getInterceptor$s(t1);
        t3 = t1.length;
        t4 = position - 1;
        ...
        do {
          if (position0 === t3)
            this.fail$2(t4, "Unterminated string");
          char = t2._codeUnitAt$1(t1, position0);
          if (char === 34) {
            this.listener.value = C.JSString_methods.substring$2(t1, position, position0);
            return position0 + 1;
          }
          if (char < 32)
        ...
        for (; true;) {
          if (position0 === t3)
            this.fail$2(t4, "Unterminated string");
          char = C.JSString_methods._codeUnitAt$1(t1, position0);
          switch (char) {
            case 98:
              char = 8;
              break;
            ...
            case 117:
              ...
              for (value = 0, i = 0; i < 4; ++i) {
                ...
                if (position0 === t3)
                  this.fail$2(t4, "Unterminated string");
                char = C.JSString_methods._codeUnitAt$1(t1, position0) - 48;
                if (char < 0)
          ...
          do {
            ...
            char = C.JSString_methods._codeUnitAt$1(t1, position0);
            if (char === 34) {
              result = P.String_String$fromCharCodes(chars, 0, null);
      ...
      parseNumber$2: function(char, position) {
        var t1, $length, position0, value, t2, isDouble, literal;
        t1 = this.source;
        $length = t1.length;
        if (char === 45) {
          ...
          char = J._codeUnitAt$1$s(t1, position0);
        } else
          position0 = position;
        if (char < 48 || char > 57)
          this.fail$2(position0, "Missing expected digit");
        if (char === 48) {
          ++position0;
          if (position0 === $length) {
            value = H.Primitives_parseInt(J.substring$2$s(t1, position, position0), null, null);
          ...
          do {
            ++position0;
            if (position0 === $length) {
              value = H.Primitives_parseInt(t2.substring$2(t1, position, position0), null, null);
              this.listener.value = value;
              return position0;
            }
            char = t2._codeUnitAt$1(t1, position0);
        ...
        if (char === 46) {
          ...
          if (position0 === $length)
            this.fail$2(position0, "Missing expected digit");
          char = J.getInterceptor$s(t1)._codeUnitAt$1(t1, position0);
          if (char < 48 || char > 57)
            this.fail$1(position0);
          do {
            ++position0;
            if (position0 === $length) {
              value = H.Primitives_parseDouble(C.JSString_methods.substring$2(t1, position, position0), null);
              this.listener.value = value;
              return position0;
            }
            char = C.JSString_methods._codeUnitAt$1(t1, position0);
        ...
        literal = J.substring$2$s(t1, position, position0);
      ...
      fail$2: function(position, message) {
        ...
        throw H.wrapException(new P.FormatException("Unexpected character at " + position + ": " + slice, null, null));
      },
    ...
    main: [function() {
      N.load_comics();
    }, "call$0", "comics__main$closure", 0, 0, 0],
    load_comics: function() {
      var list_el, req;
      list_el = document.querySelector("#comics-list");
      req = new XMLHttpRequest();
      C.HttpRequest_methods.open$2(req, "get", "/comics");
      W._EventStreamSubscription$(req, "load", new N.load_comics_closure(list_el, req), false, W.ProgressEvent);
      req.send();
    },
    attach_delete_handlers: function($parent) {
      var t1 = new W._FrozenElementList($parent.querySelectorAll(".delete"), [null]);
      t1.forEach$1(t1, new N.attach_delete_handlers_closure());
    },
    $delete: function(id, callback) {
      var req = new XMLHttpRequest();
      W._EventStreamSubscription$(req, "load", new N.delete_closure(callback, new N.delete_closure0()), false, W.ProgressEvent);
      C.HttpRequest_methods.open$2(req, "delete", "/comics/" + H.S(id));
      req.send();
    },
    graphic_novels_template: function(list) {
      var t1 = {};
      t1.html = "";
      J.forEach$1$ax(list, new N.graphic_novels_template_closure(t1));
      return t1.html;
    },
    load_comics_closure: {
      "^": "Closure:1;list_el,req",
      call$1: function(res) {
        var t1, listener;
        t1 = this.req.responseText;
        listener = new U.BuildJsonListener([], null, null, null);
        new U.JsonParser(t1, listener).parse$0();
        t1 = this.list_el;
        J.set$innerHtml$x(t1, N.graphic_novels_template(listener.get$result(listener)));
        N.attach_delete_handlers(t1);
      }
    },
    attach_delete_handlers_closure: {
      "^": "Closure:1;",
      call$1: function(el) {
        var t1 = J.get$onClick$x(el);
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, new N.attach_delete_handlers__closure(), false, H.getTypeArgumentByIndex(t1, 0));
      }
    },
    attach_delete_handlers__closure: {
      "^": "Closure:1;",
      call$1: function($event) {
        var t1 = J.getInterceptor$x($event);
        N.$delete(J.get$id$x(J.get$parent$x(t1.get$target($event))), new N.attach_delete_handlers___closure($event));
        t1.preventDefault$0($event);
      }
    },
    attach_delete_handlers___closure: {
      "^": "Closure:0;event",
      call$0: function() {
        var t1, t2;
        t1 = this.event;
        t2 = J.getInterceptor$x(t1);
        P.print("[delete] " + H.S(J.get$id$x(J.get$parent$x(t2.get$target(t1)))));
        J.remove$0$ax(J.get$parent$x(t2.get$target(t1)));
      }
    },
    delete_closure0: {
      "^": "Closure:0;",
    ...
    delete_closure: {
      "^": "Closure:1;callback,default_callback",
      call$1: function(res) {
        var t1 = this.callback;
        (t1 != null ? t1 : this.default_callback).call$0();
      }
    },
    graphic_novels_template_closure: {
      "^": "Closure:1;_box_0",
      call$1: function(graphic_novel) {
        var t1, t2;
        t1 = this._box_0;
        t2 = J.getInterceptor$asx(graphic_novel);
        t1.html = t1.html + ('    <li id="' + H.S(t2.$index(graphic_novel, "id")) + '">\n      ' + H.S(t2.$index(graphic_novel, "title")) + '\n      <a href="#" class="delete">[delete]</a>\n    </li>');
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Node, W.Node]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(N.comics__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(N.comics__main$closure(), a);
...
//# sourceMappingURL=comics.dart.js.map
